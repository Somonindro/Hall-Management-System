...
function StuShowRoomApplication(){
    ...
    useEffect(() => {
        async function fetchData() {
          fetch("http://localhost:2020/oracle-con/reg-std-stushowroomapplication",{
          method:'post',
...
export default StuShowRoomApplication;