...
function OfficialShowVacantRoom(){
    ...
    useEffect(() => {
        async function fetchData() {
          fetch("http://localhost:2020/oracle-con/reg-std-officialshowvacantroom",{
          method:'post',
  ...
  return (
        ...
        <table className='table-app'>
            ...
            <tr>
                ...
                <th className='th-app'>VACANCY</th>
            </tr>
...
export default OfficialShowVacantRoom;